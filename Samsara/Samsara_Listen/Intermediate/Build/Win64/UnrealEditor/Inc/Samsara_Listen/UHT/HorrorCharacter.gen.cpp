...
#include "Samsara_Listen/Variant_Horror/HorrorCharacter.h"
...
SAMSARA_LISTEN_API UClass* Z_Construct_UClass_AHorrorCharacter();
SAMSARA_LISTEN_API UClass* Z_Construct_UClass_AHorrorCharacter_NoRegister();
...
struct Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics
{
	struct _Script_Samsara_Listen_eventUpdateSprintMeterDelegate_Parms
	{
		float Percentage;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::NewProp_Percentage = { "Percentage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_Samsara_Listen_eventUpdateSprintMeterDelegate_Parms, Percentage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::NewProp_Percentage,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_Samsara_Listen, nullptr, "UpdateSprintMeterDelegate__DelegateSignature", Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::_Script_Samsara_Listen_eventUpdateSprintMeterDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::_Script_Samsara_Listen_eventUpdateSprintMeterDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_Samsara_Listen_UpdateSprintMeterDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FUpdateSprintMeterDelegate_DelegateWrapper(const FMulticastScriptDelegate& UpdateSprintMeterDelegate, float Percentage)
{
	...
	_Script_Samsara_Listen_eventUpdateSprintMeterDelegate_Parms Parms;
...
struct Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics
{
	struct _Script_Samsara_Listen_eventSprintStateChangedDelegate_Parms
	{
		bool bSprinting;
	};
#if WITH_METADATA
...
void Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting_SetBit(void* Obj)
{
	((_Script_Samsara_Listen_eventSprintStateChangedDelegate_Parms*)Obj)->bSprinting = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting = { "bSprinting", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(_Script_Samsara_Listen_eventSprintStateChangedDelegate_Parms), &Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_Samsara_Listen, nullptr, "SprintStateChangedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::_Script_Samsara_Listen_eventSprintStateChangedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::_Script_Samsara_Listen_eventSprintStateChangedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_Samsara_Listen_SprintStateChangedDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FSprintStateChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& SprintStateChangedDelegate, bool bSprinting)
{
	...
	_Script_Samsara_Listen_eventSprintStateChangedDelegate_Parms Parms;
...
UObject* (*const Z_Construct_UClass_AHorrorCharacter_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_ASamsara_ListenCharacter,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Samsara_Listen_Source_Samsara_Listen_Variant_Horror_HorrorCharacter_h__Script_Samsara_Listen_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AHorrorCharacter, AHorrorCharacter::StaticClass, TEXT("AHorrorCharacter"), &Z_Registration_Info_UClass_AHorrorCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AHorrorCharacter), 2839182778U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Samsara_Listen_Source_Samsara_Listen_Variant_Horror_HorrorCharacter_h__Script_Samsara_Listen_4060683919(TEXT("/Script/Samsara_Listen"),
	Z_CompiledInDeferFile_FID_Samsara_Listen_Source_Samsara_Listen_Variant_Horror_HorrorCharacter_h__Script_Samsara_Listen_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Samsara_Listen_Source_Samsara_Listen_Variant_Horror_HorrorCharacter_h__Script_Samsara_Listen_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
